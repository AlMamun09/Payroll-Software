...
namespace PayrollSoftware.Web.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        private readonly SignInManager<PayrollUser> _signInManager;
        private readonly UserManager<PayrollUser> _userManager;
        private readonly IUserStore<PayrollUser> _userStore;
        private readonly IUserEmailStore<PayrollUser> _emailStore;
        ...
        private IUserEmailStore<PayrollUser> GetEmailStore()
        {
            ...
            return (IUserEmailStore<PayrollUser>)_userStore;
        }
    }
}
